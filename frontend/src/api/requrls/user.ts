...
export const SsoBootstrapUrl = '/sso/google/bootstrap'; // Google SSO：用同源 sid cookie 引导建立本地会话
export const SsoLogoutUrl = '/sso/google/logout'; // Google SSO：登出 metersphare 本地会话
